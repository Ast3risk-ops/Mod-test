...
public class TestModMod {
	...
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation("test_mod", "test_mod"),
	...
	public TestModMod() {
		...
		MinecraftForge.EVENT_BUS.register(new TestModModFMLBusEvents(this));
	}
